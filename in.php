...
<head>
    ...
    <meta name="description" content="Farmer Details">
    <meta name="keywords" content="Farmer Details">
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Farmer</strong> <a
                    href="add-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i>
                    Add Farmer</a></div>
            ...
            <div class="card-body">
                ...
                <div class="col-sm-12">
                    ...
                    <h5 class="card-title"><i class="fa fa-fw fa-search"></i>Find Farmer</h5>
                    ...
                    <form method="get" <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="useremail" id="useremail" class="form-control"
                                    value="<?php echo isset($_REQUEST['useremail']) ? $_REQUEST['useremail'] : '' ?>"
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="tel form-control" pattern=".{14,14}" name="userphone"
                                    id="userphone" x-autocompletetype="tel"
                                    value="<?php echo isset($_REQUEST['userphone']) ? $_REQUEST['userphone'] : '' ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <button type="submit" name="submit" value="search" id="submit"
                                        class="btn btn-primary"><i class="fa fa-fw fa-search"></i> Search</button>
    ...
    <div>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><input type="checkbox" name="delete_ids[]" value="<?php echo $val['id']; ?>" class="checkbox">
                    </td>
                    <td><?php echo $s; ?></td>
                    ...
                    <td align="center">
                        <a href="edit-users.php?editId=<?php echo $val['id']; ?>" class="text-primary"><i
        ...
        <div class="text-center">
            <a href="delete.php?dlelIds=<?php echo $val['id']; ?>" class="text-danger"
                onclick="return confirm('Are you sure you want to delete the selected user(s) ?');">
