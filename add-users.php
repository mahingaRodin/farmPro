	...
	if($username==""){
		...
		if($userCount[0]['total']<100){
			...
			if($insert){
				...
				header('location:in.php?msg=ras');

				exit;

			}else{

				header('location:in.php?msg=rna');
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add Farmer</strong> <a
                    href="in.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse
                    Farmers</a></div>
                ...
                <div class="col-sm-6">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label>Farmer Phone No.:<span class="text-danger">*</span></label>

                            <input type="tel" class="tel form-control" name="userphone" id="userphone"
                                x-autocompletetype="tel" placeholder="Enter farmer phone" required>
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i
                                    class="fa fa-fw fa-plus-circle"></i> Add Farmer</button>
